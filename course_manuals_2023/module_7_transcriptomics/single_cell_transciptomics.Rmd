...
Route to folder (set your path here)
```{r}
library(knitr)
#setwd("C:/Users/alfon/OneDrive/Documentos/drive-download-20231004T173339Z-001/")
opts_knit$set(root.dir="C:/Users/alfon/OneDrive/Documentos/drive-download-20231004T173339Z-001/")
...
How can you access the cells in this object?
```{r}
head(
  colnames(sample1)
  )
...
Let's inspect the features and cell counts after doublet removal
```{r}
dim(sample1)
dim(sample2)
dim(sample3)
...
ggsave(paste0("raw_umisPerCell_somules_v10_",st,".jpg"), width = 20, height = 15)
```
...
ggsave(paste0("raw_genesPerCell_somules_v10_",st,".jpg"), width = 20, height = 15)
```
...
day2somules_metadata %>% 
	...
	scale_colour_gradient(low = "gray90", high = "black") +
  	...
  	facet_wrap(~batches)
ggsave(paste0("raw_cgenesVumis_mito_somules_v10_bybatch_",st,".jpg"), width = 20, height = 15)
```
...
ggsave(paste0("day2somules_v10clust_40PC_0.4res_RNA",st,".jpg"))
```
